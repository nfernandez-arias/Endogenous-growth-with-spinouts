function out = aggregation(pa,pm,ig,V_out,W_out)

	% Here, implement the solution to the system of equations

	% To do this, first implement change of variables. This consists of defining a new grid in m'-space, and a new function tau1(m') = tau(m(m')).
