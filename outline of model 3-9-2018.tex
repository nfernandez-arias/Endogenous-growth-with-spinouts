...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Talk to Esteban about Jamie's tentative \$3,500 quote, given >80-90\% coverage of bio information in all state-years. 
		\end{itemize}
		...
		\begin{itemize}
			\item Having some issues implementing Moll's algorithm - it's not converging. Implicit method seems impossible. Probably need to talk to someone in order to get this to work, but will try to get it to work this weekend.
		\end{itemize}
	\end{itemize}
	\item Theory:
	\begin{itemize}
...
\section{Existing model: Klette \& Kortum-style, permanent non-competes, etc.}
