...
png("figures/plotsGR/calibration_noCNC/HJB_solutions_plot.png")
...
png("figures/plotsGR/calibration_noCNC/Incumbent_AggSpinout_Values.png")
...
png("figures/plotsGR/calibration_noCNC/HJB_tests.png")
...
png("figures/plotsGR/calibration_noCNC/innovation_rates_m")
...
png("figures/plotsGR/calibration_noCNC/innovation_rates_t")
...
png("figures/plotsGR/calibration_noCNC/wages_m.png")
...
png("figures/plotsGR/calibration_noCNC/wages_t.png")
...
png("figures/plotsGR/calibration_noCNC/drift.png")
...
png("figures/plotsGR/calibration_noCNC/drift_sources_m.png")
...
png("figures/plotsGR/calibration_noCNC/drift_sources_t.png")
...
png("figures/plotsGR/calibration_noCNC/mushape.png")
...
if maximum(noncompete) == 0 || idxCNC > 1
    ...
    png("figures/plotsGR/calibration_noCNC/gamma_t_μ_vs_m_plots.png")
...
if maximum(noncompete) == 0 || idxCNC > 1
    ...
    png("figures/plotsGR/calibration_noCNC/gamma_t_μ_vs_t_plots.png")
...
png("figures/plotsGR/calibration_noCNC/effectiveRDWage_vs_m.png")
...
png("figures/plotsGR/calibration_noCNC/effectiveRDWage_vs_t.png")
...
png("figures/plotsGR/calibration_noCNC/diagnostics/zEzIRatioDecomp_checksum.png")
...
png("figures/plotsGR/calibration_noCNC/diagnostics/zEzIRatioDecomp.png")
...
png("figures/plotsGR/calibration_noCNC/noncompete_usage_m.png")

p = plot(t,noncompete,title = "Noncompete usage", xlabel = "Years since last innovation", ylabel = "Usage = 1")
png("figures/plotsGR/calibration_noCNC/noncompete_usage_t.png")
