...
spinoutEmploymentShare = SimpleCalibrationTarget(0.1,1)
rdShare = SimpleCalibrationTarget(0.0135,1)
...
@time calibrationResults,finalMoments,sol,finalScore = calibrateModel_noCreativeDestructionCost(modelPar,calibPar)
