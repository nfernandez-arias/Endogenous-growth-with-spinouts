...
\begin{figure}[]
	\centering
	\includegraphics[scale=0.65]{../empirics/figures/plots/industry_row_heatmap_naics2_founder2_ggplot2.png}
...
\begin{table}[]
	\caption{Main regressions\tabnoteref[a]{tab1}}\centering
...
\section{Apprendix of Tables}\label{appendix:tables}
\setcounter{table}{0}
