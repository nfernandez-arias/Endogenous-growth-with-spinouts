...
\begin{figure}[p]
	\centering
	\input{../empirics/tables/presentationRegressions_fd_noFE.tex}
	\caption{Regression}
...
\begin{figure}[p]
	\centering
	\input{../empirics/tables/presentationRegressions_FE.tex}
...
\begin{figure}[p]
	\centering
	\input{../empirics/tables/presentationRegressions_fd_FE.tex}
...
\begin{figure}[p]
	\centering
	\small
	\input{../empirics/tables/regs_spinouts_accounting.tex}
...
\begin{figure}[p]
	\centering
	\small
	\input{../empirics/tables/regs_spinouts_wso4_accounting.tex}
