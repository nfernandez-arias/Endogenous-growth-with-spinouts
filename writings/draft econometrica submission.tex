...
\runtitle{Endogenous Growth with Employee Spinouts, Noncompetes, and Creative Destruction}
...
\author[id=au1,addressref={add1,add11}]{\fnms{Nicolas}~\snm{Fernandez-Arias}\ead[label=e1]{fernandezarias.nicolas@gmail.com}}

%\author{Nicolas Fernandez-Arias \thanks{Comments are appreciated and can be sent to nfernand@princeton.edu.}\\ Princeton University} 1`
\date{\today \\ \small
