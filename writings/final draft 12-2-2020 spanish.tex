...
\author{Nicolás Fernández-Arias \thanks{Comments are appreciated and can be sent to nfernand@princeton.edu.}\\ Princeton University} 
\date{\today \\ \small
...
\begin{figure}[]
	\centering
	\includegraphics[scale = 0.56]{../code/julia/figures/simpleModel/identificationSourcesFull.png}
...
\begin{figure}[]
	\centering
	\includegraphics[scale = 0.7]{../code/julia/figures/simpleModel/welfareComparisonParameterSensitivityFull.png}
...
\begin{table}[]
	...
	\begin{tabular}{rlll}
		...
		\tabularnewline
		$\psi$ & 0.5 & Incumbent R\&D elasticity & External \tabularnewline
		$\hat{\psi}$ & 0.5 & Entrant R\&D elasticity & External \tabularnewline
