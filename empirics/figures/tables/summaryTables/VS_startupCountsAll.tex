...
\begin{table}[!htb]
\caption{Summary of Venture Source data\tabnoteref[a]{tab1}}\label{table:VS_summaryTable}
\centering
...
\tabnotetext[a]{tab1}{Statistics on startups covered by VS sample. Industry information uses VS industrial classification. Startups are counted by founding year, individuals by year they joined the firm.}
