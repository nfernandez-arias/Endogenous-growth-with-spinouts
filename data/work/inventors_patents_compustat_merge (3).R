...
inventors_patents_dynass <- inventors_patents_dynass[(inventors_patents_dynass$_merge == 3),]
inventors_patents_dynass$_merge <- NULL
...
# names(inventors_patents_dynass)[names(inventors_patents_dynass) == '_merge'] <- '_merge'
# Merge
