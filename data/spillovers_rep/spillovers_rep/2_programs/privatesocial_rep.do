...
set more off
set maxvar 11000
* NOTES: INPUTS ARE experiment_.dta & spillovers_big.dta
* this section constructs what was "spillovers_big.dta" and "experiment_.dta"
u "$data/rsample",clear
collapse (mean) xrd (firstnm) sic, by(gvkey)
gen mgrd=xrd/0.1
rename gvkey gvkey_
drop xrd
tempfile mgrd
